...
if __name__ == '__main__':
    ...
    if caso == 'menu_factory':
        ...
        class TopClass(tk.Tk):
            ...
            def setGui(self):
                # file_path = '@data:tkinter/tkUiEditor'
                file_path = '@data:tkinter/tkUiEditor_menu_states'
    ...
    if caso == 'kodiwidgets_custom_dialog':
        import mywidgets.Widgets.kodiwidgets as kodiwidgets
        ...
        from mywidgets.Tools.uiStyle.uicss import CssWrapper
        ...
        labelImg = 'dummy' # getLabel(label, font, 'blue', **options)  # arreglar esto
        ...
        if caso == 'tkinter':
            ...
            fframe = userinterface.newPanelFactory(top, selPane)
